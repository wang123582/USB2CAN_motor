...
bool motor_control_ros2__msg__dji_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_control_ros2.msg._dji_motor_state.DJIMotorState", full_classname_dest, 53) == 0);
  }
  motor_control_ros2__msg__DJIMotorState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DJIMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_control_ros2.msg._dji_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DJIMotorState");
