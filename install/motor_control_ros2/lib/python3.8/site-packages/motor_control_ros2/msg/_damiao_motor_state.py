...
class Metaclass_DamiaoMotorState(type):
    """Metaclass of message 'DamiaoMotorState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'motor_control_ros2.msg.DamiaoMotorState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__damiao_motor_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__damiao_motor_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__damiao_motor_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__damiao_motor_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__damiao_motor_state
...
class DamiaoMotorState(metaclass=Metaclass_DamiaoMotorState):
    """Message class 'DamiaoMotorState'."""
    ...
    def temp_mos(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'temp_mos' field must be an unsigned integer in [0, 255]"
    ...
    def temp_rotor(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'temp_rotor' field must be an unsigned integer in [0, 255]"
