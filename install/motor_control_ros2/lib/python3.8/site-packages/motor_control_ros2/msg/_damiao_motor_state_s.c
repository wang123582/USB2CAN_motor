...
bool motor_control_ros2__msg__damiao_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_control_ros2.msg._damiao_motor_state.DamiaoMotorState", full_classname_dest, 59) == 0);
  }
  motor_control_ros2__msg__DamiaoMotorState * ros_message = _ros_message;
  {  // header
  ...
  {  // temp_mos
    ...
    ros_message->temp_mos = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // temp_rotor
    ...
    assert(PyLong_Check(field));
    ros_message->temp_rotor = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // error_code
...
{
  /* NOTE(esteve): Call constructor of DamiaoMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_control_ros2.msg._damiao_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DamiaoMotorState");
  ...
  {  // temp_mos
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->temp_mos);
    {
  ...
  {  // temp_rotor
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->temp_rotor);
    {
