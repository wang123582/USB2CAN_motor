...
class Metaclass_MotorStateGeneric(type):
    """Metaclass of message 'MotorStateGeneric'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'motor_control_ros2.msg.MotorStateGeneric')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__motor_state_generic
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__motor_state_generic
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__motor_state_generic
            cls._TYPE_SUPPORT = module.type_support_msg__msg__motor_state_generic
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__motor_state_generic
...
class MotorStateGeneric(metaclass=Metaclass_MotorStateGeneric):
    """Message class 'MotorStateGeneric'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_type = kwargs.get('motor_type', str())
    ...
    def motor_type(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'motor_type' field must be of type 'str'"
