...
bool motor_control_ros2__msg__unitree_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_control_ros2.msg._unitree_motor_state.UnitreeMotorState", full_classname_dest, 61) == 0);
  }
  motor_control_ros2__msg__UnitreeMotorState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UnitreeMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_control_ros2.msg._unitree_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UnitreeMotorState");
